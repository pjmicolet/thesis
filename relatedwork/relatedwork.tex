...
When cores are fused, they collectively fetch from the same thread, whenever an instruction cache miss is issued, an eight word block is delivered and distributed across in all of the cores' caches.
...
If the memory address is contained in the data cache, then the value is fetched (this is considered a prediction).
