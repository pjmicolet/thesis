...
The reason this technique cannot improve performance much more is due to the fact that it only attempts to smartly schedule instructions that cause dependencies.
