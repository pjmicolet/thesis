...
Using this information, a dynamic runtime reconfiguration scheme is created:  \textbf{DSpeed} that matches the speed of the fastest static core fusion whilst minimising energy consumption.% and \textbf{DEff} that maximizes efficiency.
