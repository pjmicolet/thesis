...
Static ahead-of-time configurations can improve the overall performance of programs, however it cannot adapt itselt to exploit the different phases a program may have.
