...
Chapter~\ref{chp:streamit} explored multi-threaded applications yet core composition is designed to improve the performance of single threaded applications~\cite{chp:ipek2007CoreFusion} as it has become harded to improve performance for these types of applications.
