...
\begin{figure*}[t]
    \centering
	\includegraphics[width=1\textwidth]{cases-paper/graphics/results/speed_bars.pdf}
\vspace*{-2em}
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=1\textwidth]{cases-paper/graphics/results/edd_bars.pdf}
\vspace*{-8mm}
