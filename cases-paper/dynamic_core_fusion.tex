...
Since the maximum number of clusters found is 7 (for SVM), a maximum of $5^{7} = 78125$ different dynamic execution traces can be built.
...
This scheme is used to demonstrate how dynamic reconfiguration can outperform static configuration when only concerned with the speed of execution.
