...
Most applications run for a couple hundred million cycles, which often takes a couple of hours to execute.
...
\begin{figure}[t]
     \centering	
	 \vspace{-1em}
     \subfloat[][Disparity]{\includegraphics[width=0.3\textwidth]{cases-paper/graphics/Pareto/DispN3.pdf}\vspace*{-4mm}\label{subfig:disp}}
     \subfloat[][Localization]{\includegraphics[width=0.3\textwidth]{cases-paper/graphics/Pareto/LocN3.pdf}\vspace*{-4mm}\label{subfig:loc}}
     \subfloat[][MSER]{\includegraphics[width=0.3\textwidth]{cases-paper/graphics/Pareto/MSERN3.pdf}\label{subfig:mser}}\
	 	 	 \vspace{-0.5em}

     \subfloat[][Multi\_Ncut]{\includegraphics[width=0.3\textwidth]{cases-paper/graphics/Pareto/MultiN3.pdf}\label{subfig:mult}}
     \subfloat[][Sift]{\includegraphics[width=0.3\textwidth]{cases-paper/graphics/Pareto/SiftN3.pdf}\label{subfig:sift}}
     \subfloat[][Stitch]{\includegraphics[width=0.3\textwidth]{cases-paper/graphics/Pareto/StitchN3.pdf}\label{subfig:stitch}}\
	 	 	 \vspace{-0.5em}

     \subfloat[][SVM]{\includegraphics[width=0.3\textwidth]{cases-paper/graphics/Pareto/SVMN3.pdf}\label{subfig:svm}}
     \subfloat[][Texture\_Synthesis]{\includegraphics[width=0.3\textwidth]{cases-paper/graphics/Pareto/TextN3.pdf}\label{subfig:text}}
     \subfloat[][Tracking]{\includegraphics[width=0.3\textwidth]{cases-paper/graphics/Pareto/TrackingN3.pdf}\label{subfig:track}}
...
For a given cycle count, the reconfiguration scheme that led to the smallest energy consumption is then chosen to be a point in the Pareto Front.
...
This is due to the fact that larger core-compositions do not result in linear speedups, and thus they will consume more energy than a smaller core-composition.
...
The SS core count is obtained by averaging the number of cores that led to the fastest execution time for each benchmark.
...
%More here
The dynamic reconfiguration \textbf{DSpeed} scheme always performs better than the SB scheme and can even match the SS scheme on energy consumption whilst improving speed such as in the \bm{Sift} benchmark.
...
It is also important to note that these are vision benchmarks, and that working on larger inputs will increase the length of the average phase time.
