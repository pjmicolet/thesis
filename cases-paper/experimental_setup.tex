...
Due to executing these benchmarks on a cycle accurate simulator, executing on large datasets can take a prohobitive amount of time.
...
For this chapter, the aim is to have a dataset that leads to executing at least 100 million cycles.
