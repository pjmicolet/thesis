...
Due to the fact that the programs are already being traced for their IPC, SimPoint does not have to be applied here. 
...
\subsection{Static Ahead-of-Time Core Fusion Exploration}
...
For example, running the \bm{Disparity} benchmark on a LC of 16 cores, it can be observed that an average IPC of 8.3.
...
Listing~\ref{lsting:multi} in the Apendix shows the source code of the main phase of \bm{Multi\_NCut}, the main loop found at lines 49 to 58, also found in Listing~\ref{lst:multi_loop}.
