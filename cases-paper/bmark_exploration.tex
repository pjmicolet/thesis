...
\begin{figure}[t]
     \centering	
	 \vspace{-1em}
     \subfloat[][Disparity]{\includegraphics[width=0.33\textwidth]{cases-paper/graphics/Exploration/disparity-sse.pdf}\vspace*{-4mm}\label{subfig:disp}}
     \subfloat[][Localization]{\includegraphics[width=0.33\textwidth]{cases-paper/graphics/Exploration/localization-sse.pdf}\vspace*{-4mm}\label{subfig:loc}}
     \subfloat[][MSER]{\includegraphics[width=0.33\textwidth]{cases-paper/graphics/Exploration/mser-sse.pdf}\label{subfig:mser}}\
	 	 	 \vspace{-0.5em}

     \subfloat[][Multi\_Ncut]{\includegraphics[width=0.33\textwidth]{cases-paper/graphics/Exploration/multi-sse.pdf}\label{subfig:mult}}
     \subfloat[][Sift]{\includegraphics[width=0.33\textwidth]{cases-paper/graphics/Exploration/sift-sse.pdf}\label{subfig:sift}}
     \subfloat[][Stitch]{\includegraphics[width=0.33\textwidth]{cases-paper/graphics/Exploration/stitch-sse.pdf}\label{subfig:stitch}}\
	 	 	 \vspace{-0.5em}

     \subfloat[][SVM]{\includegraphics[width=0.33\textwidth]{cases-paper/graphics/Exploration/svm-sse.pdf}\label{subfig:svm}}
     \subfloat[][Texture\_Synthesis]{\includegraphics[width=0.33\textwidth]{cases-paper/graphics/Exploration/texture-sse.pdf}\label{subfig:text}}
     \subfloat[][Tracking]{\includegraphics[width=0.33\textwidth]{cases-paper/graphics/Exploration/tracking-sse.pdf}\label{subfig:track}}
...
In order to find the correct number of clusters the Sum of Square Errors (SSE) is plotted for a given cluster size from 1 to 15 and the optimal cluster is defined as the elbow in the plot~\cite{everitCluster2001}.
...
Figure~\ref{fig:clust} shows the number of clusters for each benchmark and the number of times a tick in each cluster occurs throughout the execution of the program.
...
For example, benchmarks \bm{MSER} and \bm{Multi\_NCut} feature two phases, with one of those phases covering over 80\% of the total execution.
