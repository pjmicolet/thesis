...
The Figure shows that benchmarks \bm{Multi\_NCut} features a very low variance; this partially explains why RRF has a similar fetch to dispatch latency as SF without value prediction.
