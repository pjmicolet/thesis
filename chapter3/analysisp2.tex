...
In Section~\ref{chp:chp3:sec:analysis}, Figure~\ref{fig:av_time} showed that, when using RRF, there is a minimum latency of 10 cycles from fetch to dispatch, meaning that the predictor can issue 8 to 16 predictions before dispatching any block.
