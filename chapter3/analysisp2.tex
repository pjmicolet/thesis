...
To determine the size, all the EDGE blocks of the SD-VBS benchmarks are analysed to determine the average register read and write count per block.
The writes are tracked as it provides information on the potential number of register dependencies found in each of the applications.
