...
Figure~\ref{fig:motivation_reg} shows how the performance of core composition using the OF scheme is affected if blocks can immediately resolve their data dependencies on the \bm{MSER} benchmark.
