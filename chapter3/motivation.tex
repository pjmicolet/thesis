...
Figure~\ref{fig:mser_motiv} shows the speedup obtained when executing \bm{MSER} on core compositions of size 2, 4, 8, 16 when using perfect branch prediction.
