...
\bench{FilterBank} distributes its inputs amongst an array of discrete fourier transform (DFT) filters, the outputs of the DFT filters are downsampled, upsampled and then recombined to form a processed signal~\cite{streamitrepo}.
