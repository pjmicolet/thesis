...
\bench{FilterBank} has an array of discrete fourier transform filters that take a signal as an input, and their outputs are downsampled, upsampled and then recombined to form a processed signal~\cite{streamitrepo}.
