...
\begin{figure}[t]
  \includegraphics[width=0.5\textwidth]{streamit-paper/graphics/audiobeam_tots.pdf}
...
\begin{figure}[t]
  \includegraphics[width=0.5\textwidth]{streamit-paper/graphics/unrolled_fm.pdf}
