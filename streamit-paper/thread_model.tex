...
This difficulty arises from trying to balance between exploiting block level parallelism (BLP) by composing a large amount of cores and exploiting TLP by generating more threads.
