...
Overall, this leads to a total space size of 32,767 unique combination per benchmark as previously described in Section~\ref{sec:motivation-str}.
...
To generate the random space, for each number of worker threads possible (1 to 15), 100 core to threads mappings were generated (when possible).
...
The configurations generated do not have to utilise all available cores in the system, as some cores can simply be turned off.
