...
However, these potential performance improvements are made difficult due to two main challenges: the difficulty of determining an processor configuration that leads to the optimal performance and know how to reduce hardware bottlenecks that may impede the performance of composition.
