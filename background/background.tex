...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.5\textwidth]{background/graphics/smallest_clust_example.pdf}
	\vspace{-1em}
...
This section covers the Early Stopping Criterion used in Chapter~\ref{chp:streamit}, where a design space of 32,000 different configurations of the processor can be explored.
Since this space is too large to fully cover, as will be explained in Chapter~\ref{chp:streamit} Section~\ref{chp:stream:sec:setup}, only a sub-sample of the space is used.
The early stopping criterion is therefore used to determine when the number of points explored in the sub-sample space is representative of the total space.
